              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      "Radix Colors provides 12 color steps, designed for white foreground text at step 9."
...
List<_ColorsDemo> colorMap() {
  return [
    ...
    _ColorsDemo(
      name: "Ruby",
      primary: RadixColors.ruby,
      accent: RadixColors.rubyA,
      primaryDark: RadixColors.dark.ruby,
      accentDark: RadixColors.dark.rubyA,
    ),
    _ColorsDemo(
      name: "Crimson",
    ...
    _ColorsDemo(
      name: "Iris",
      primary: RadixColors.iris,
      accent: RadixColors.irisA,
      primaryDark: RadixColors.dark.iris,
      accentDark: RadixColors.dark.irisA,
    ),
    _ColorsDemo(
      name: "Indigo",
    ...
    _ColorsDemo(
      name: "Jade",
      primary: RadixColors.jade,
      accent: RadixColors.jadeA,
      primaryDark: RadixColors.dark.jade,
      accentDark: RadixColors.dark.jadeA,
    ),
    _ColorsDemo(
      name: "Green",
